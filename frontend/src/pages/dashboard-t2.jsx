...
export default function T2() {
  ...
  // Visibles para T2: solo tareas con assigned_role = 3
  const visibleTasks = useMemo(
    () => (tasks || []).filter(t => Number(t.assigned_role) === 3),
    [tasks]
  );
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 p-6">
        <h2 className="text-2xl font-bold mb-12 text-center">Panel T2</h2>

        {/* Buscador sobre lo que T2 puede ver */}
